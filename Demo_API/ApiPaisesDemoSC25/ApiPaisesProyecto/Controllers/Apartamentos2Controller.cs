...
namespace ApiPaisesProyecto.Controllers
{
    ...
    [ApiController]
    public class Apartamentos2Controller : ControllerBase
    {
        private readonly ContextoBaseDatos _context;

        public Apartamentos2Controller(ContextoBaseDatos context)
        {
            _context = context;
        }

        // GET: api/Apartamentos2
        [HttpGet]
